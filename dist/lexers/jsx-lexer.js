  ...
  function JsxLexer() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};_classCallCheck(this, JsxLexer);var _this = _possibleConstructorReturn(this, (JsxLexer.__proto__ || Object.getPrototypeOf(JsxLexer)).call(this,
    ...
    node, sourceText) {var _this3 = this;
      ...
      if (tagNode.tagName.text === 'Trans') {
        ...
        var tOptionsAttribute = tagNode.attributes.properties.find(
        function (attr) {return attr.name.text === 'tOptions';});

        var tOptionsProperties = tOptionsAttribute ?
        tOptionsAttribute.initializer.expression.properties :
        [];
        var defaultValueProperties = tOptionsProperties.filter(function (p) {return (
            p.name.text.startsWith('defaultValue'));});var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {

          for (var _iterator = defaultValueProperties[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var property = _step.value;
